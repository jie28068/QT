...
public:
    ...
    void setHeaderLabels(const QStringList &labels); // firecat add
    void setContextMenu(QAction *action);            // firecat add
    void clearContextMenu(void);                     // firecat add
    QModelIndex currentIndex() const;                // firecat add
    QModelIndexList selectedIndexes() const;         // firecat add
