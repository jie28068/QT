...
#endif
                                                    ,
                                                    _shadeEnabled(true), _shadeRoundEnabled(true), _doubleClickedMaxEnabled(true), _doubleClickHeight(20)
{
    ...
    shadowPixmapList.append(QPixmap(":/images/shadow_left"));
    shadowPixmapList.append(QPixmap(":/images/shadow_left_top"));
    shadowPixmapList.append(QPixmap(":/images/shadow_top"));
    shadowPixmapList.append(QPixmap(":/images/shadow_right_top"));
    shadowPixmapList.append(QPixmap(":/images/shadow_right"));
    shadowPixmapList.append(QPixmap(":/images/shadow_right_bottom"));
    shadowPixmapList.append(QPixmap(":/images/shadow_bottom"));
    shadowPixmapList.append(QPixmap(":/images/shadow_left_bottom"));
#endif
