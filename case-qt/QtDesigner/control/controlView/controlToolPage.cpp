...
ControlToolPage::ControlToolPage(QString text, QWidget *parent) : QWidget(parent), m_text(text)
{
    ...
    {
        model->addItem(GlobalDefinition::controlManyToOne, GlobalDefinition::controlParameters, QVariant());
        model->addItem(GlobalDefinition::controlOneToMany, GlobalDefinition::controlParameters, QVariant());
    }
    ...
    connect(m_listView, &ControlToolListView::clickedControl, this, &ControlToolPage::clickedControlPage);
}
