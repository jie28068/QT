#ifndef CONTROLMANYTOONE_H
#define CONTROLMANYTOONE_H
...
class ControlManyToOne : public ControlBase
{
    Q_OBJECT
...
public:
    explicit ControlManyToOne(QObject *parent = nullptr);
...
Q_DECLARE_METATYPE(ControlManyToOne *)
