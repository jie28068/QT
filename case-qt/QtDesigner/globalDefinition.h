...
namespace GlobalDefinition
{
    ...
    static const int controlItemData = Qt::UserRole + 5;    // 节点数据
    ...
    // 属性
    static const QString controlName = "controlName";                 // 名称
    ...
    static const QString controlOneToMany = "OneToMany";
    static const QString controlManyToOne = "ManyToOne";
