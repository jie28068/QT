...
public:
    ...
    void SearchTableData(const QString &searchText);
...
private:
    ...
    void UpdateTableViewWithSearchResults(const QList<QStringList> &filteredData);

signals:
    void SigPageStateChanged(int page);
    void SigSearchResults(QList<QStringList>);
